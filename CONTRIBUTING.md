...
The Lykos project operates an open contributor model where anyone is
...
The following applies to code changes to the Lykos project, and is not to be
confused with overall LYKOS Network Protocol consensus changes.

Whether a pull request is merged into Lykos rests with the project merge
...
Patches that change LYKOS consensus rules are considerably more involved than
...
Where a patch set proposes to change the LYKOS consensus, it must have been
...
The project leader is the release manager for each Lykos release.
