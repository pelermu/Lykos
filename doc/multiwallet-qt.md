...
In order to support loading of multiple wallets in lykos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lykos.cpp.
...
Changes to lykos.cpp
----------------------
lykos.cpp is the entry point into lykos-qt, and as such, will require some minor modifications to provide hooks for
