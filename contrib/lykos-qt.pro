...
RESOURCES += src/qt/lykos.qrc src/qt/lykos_locale.qrc

TRANSLATIONS += src/qt/locale/lykos_bg.ts \
                src/qt/locale/lykos_de.ts \
                src/qt/locale/lykos_en.ts \
                src/qt/locale/lykos_es.ts \
                src/qt/locale/lykos_fi.ts \
                src/qt/locale/lykos_fr.ts \
                src/qt/locale/lykos_it.ts \
                src/qt/locale/lykos_ja.ts \
                src/qt/locale/lykos_pl.ts \
                src/qt/locale/lykos_pt.ts \
                src/qt/locale/lykos_ru.ts \
                src/qt/locale/lykos_sk.ts \
                src/qt/locale/lykos_sv.ts \
                src/qt/locale/lykos_vi.ts \
                src/qt/locale/lykos_zh_CN.ts \
                src/qt/locale/lykos_zh_TW.ts
