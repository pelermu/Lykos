...
This means one can have an always-on lykosd instance running, and another local lykosd/lykos-qt instance which connects to this node and receives blocks from it.
