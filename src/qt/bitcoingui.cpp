...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LYKOS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lykos: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lykos"), this);
    aboutAction->setStatusTip(tr("Show information about Lykos"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LYKOS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LYKOS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LYKOS addresses"));
    ...
    openAction->setStatusTip(tr("Open a LYKOS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lykos help message to get a list with possible LYKOS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lykos client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LYKOS network", "", count));
}
...
{
    QString strTitle = tr("Lykos"); // default title
