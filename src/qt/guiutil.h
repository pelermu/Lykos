...
/** Utility functions used by the LYKOS Qt UI.
 */
namespace GUIUtil
{
...
// Render LYKOS addresses in monospace font
...
// Parse "lykos:" URI into recipient object, return true on successful parsing
