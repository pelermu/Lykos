...
#if defined(NDEBUG)
#error "LYKOS cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight >= 2 && nHeight <= 3252) {
      nSubsidy = 25 * COIN;
    } else if (nHeight >= 3253 && nHeight <= 38446) {
      nSubsidy = 100 * COIN;
    } else if (nHeight >= 38447 && nHeight <= 101447) {
      nSubsidy = 120 * COIN;
    } else if (nHeight >= 101448 && nHeight <= 209800) {
      nSubsidy = 70 * COIN;
    } else if (nHeight >= 209801 && nHeight <= 415994) {
      nSubsidy = 50 * COIN;
    } else if (nHeight >= 415995 && nHeight <= 835874) {
      nSubsidy = 21 * COIN;
    } else if (nHeight >= 835875) {
      nSubsidy = 15 * COIN;
    }
