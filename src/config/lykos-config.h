/* src/config/lykos-config.h.  Generated from lykos-config.h.in by configure.  */
/* src/config/lykos-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Lykos_CONFIG_H

#define Lykos_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.lykos.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lykos Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lykos Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lykos"
