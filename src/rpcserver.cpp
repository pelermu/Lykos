...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lykos features */
        {"lykos", "masternode", &masternode, true, true, false},
        {"lykos", "listmasternodes", &listmasternodes, true, true, false},
        {"lykos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lykos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lykos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lykos", "masternodedebug", &masternodedebug, true, true, false},
        {"lykos", "startmasternode", &startmasternode, true, true, false},
        {"lykos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lykos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lykos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lykos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lykos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lykos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lykos", "mnbudget", &mnbudget, true, true, false},
        {"lykos", "preparebudget", &preparebudget, true, true, false},
        {"lykos", "submitbudget", &submitbudget, true, true, false},
        {"lykos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lykos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lykos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lykos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lykos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lykos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lykos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lykos", "checkbudgets", &checkbudgets, true, true, false},
        {"lykos", "mnsync", &mnsync, true, true, false},
        {"lykos", "spork", &spork, true, true, false},
        {"lykos", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lykos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lykosd, or the -server option to lykos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lykos-cli " + methodname + " " + args + "\n";
}
